...
class MainActivity6Sub : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (value == 1) {
            ...
            bringButton.setOnClickListener {
                ...
                myRef.child("21").setValue(Meat("오 렌 지 에 이 드", number, number * 2700))
        ...
        if (value == 2) {
            ...
            bringButton.setOnClickListener {
                ...
                val database = Firebase.database
                val myRef = database.getReference("table")
                myRef.child("22").setValue(Meat("레 몬 에 이 드", number, number * 2700))
                intent = Intent(this, MainActivity6::class.java)
                intent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION)
                startActivity(intent)
            }
        ...
        if (value == 3) {
            ...
            bringButton.setOnClickListener {
                ...
                val database = Firebase.database
                val myRef = database.getReference("table")
                myRef.child("23").setValue(Meat("자 몽 에 이 드", number, number * 2700))
                intent = Intent(this, MainActivity6::class.java)
                intent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION)
                startActivity(intent)
        ...
        if (value == 4) {
            ...
            bringButton.setOnClickListener {
                ...
                val database = Firebase.database
                val myRef = database.getReference("table")
                myRef.child("24").setValue(Meat("레 드 와 인 쿨 러", number, number * 6900))
                intent = Intent(this, MainActivity6::class.java)
                intent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION)
                startActivity(intent)
        ...
        if (value == 5) {
            ...
            bringButton.setOnClickListener {
                ...
                val database = Firebase.database
                val myRef = database.getReference("table")
                myRef.child("25").setValue(Meat("화 이 트 와 인 쿨 러", number, number * 6900))
                intent = Intent(this, MainActivity6::class.java)
                intent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION)
                startActivity(intent)
        ...
        if (value == 6) {
            ...
            bringButton.setOnClickListener {
                ...
                val database = Firebase.database
                val myRef = database.getReference("table")
                myRef.child("26").setValue(Meat(" 사 이 다 ", number, number * 4500))
                intent = Intent(this, MainActivity6::class.java)
                intent.addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION)
                startActivity(intent)
